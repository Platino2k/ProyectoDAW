...
function BATTLE($db, $world, $lang, $armyPOWER)
{
    ...
    if (!empty($result)) {
        ...
        for ($i = 0; $i <= $MAXquantity; $i++) {
            ...
            if ($unit1 < $unit2) {
                ...
                if ($unit1 == 5) {
                    $quantities1['L_CAVALRY']--;
                }
                if ($unit1 == 8) {
                    $quantities1['H_CAVALRY']--;
                }
                ...
                if ($unit2 == 5) {
                    $quantities2['L_CAVALRY']--;
                }
                if ($unit2 == 8) {
                    $quantities2['H_CAVALRY']--;
                }
            }
    ...
    if ($ATTPOINT > $DEFPOINT) {
        ...
        $MAX = 500;
        if ($result4[5]["BUILDING"] == "storehouse_2") {
            $MAX = 1000;
        } else if ($result4[5]["BUILDING"] == "storehouse_3") {
            $MAX = 1500;
        }
        ...
        if (($result5['WOOD'] + $wood) > $MAX) {
            $wood = $MAX;
        } else {
            $wood = $result5['WOOD'] + $wood;
        }
        if (($result5['FOOD'] + $food) > $MAX) {
            $food = $MAX;
        } else {
            $food = $result5['FOOD'] + $food;
        }
        if (($result5['STONE'] + $stone) > $MAX) {
            $stone = $MAX;
        } else {
            $stone = $result5['STONE'] + $stone;
        }
        if (($result5['IRON'] + $iron) > $MAX) {
            $iron = $MAX;
        } else {
            $iron = $result5['IRON'] + $iron;
        }
...
function UPGRADEBUILDING($db, $world, $cost)
{
    ...
    if (!$result4) {
        ...
        if (
            $result3["FOOD"] >= $cost[$NEWbuilding][1] &&
        ...
        for ($i = 0; $i < count($building); $i++) {
            for ($n = 0; $n < count($result3); $n++) {
                if ($buildingKEY[$i] == $result3[$n]['BUILDING'] && $counter < 4) {
                    ...
                    if ($resource[0] == 'wood') {
                        if ($result3[5]["BUILDING"] == "storehouse_1" && $wood >= 500) {
                            $wood = 500;
                        } else if ($result3[5]["BUILDING"] == "storehouse_2" && $wood >= 1000) {
                            $wood = 1000;
                        } else if ($result3[5]["BUILDING"] == "storehouse_3" && $wood >= 1500) {
                            $wood = 1500;
                        }
                        ...
                        if ($result3[5]["BUILDING"] == "storehouse_1" && ($result4['FOOD'] + $ammount) >= 500) {
                            $food = 500;
                        } else if ($result3[5]["BUILDING"] == "storehouse_2" && ($result4['FOOD'] + $ammount) >= 1000) {
                            $food = 1000;
                        } else if ($result3[5]["BUILDING"] == "storehouse_3" && ($result4['FOOD'] + $ammount) >= 1500) {
                            $food = 1500;
                        }
                        ...
                        if ($result3[5]["BUILDING"] == "storehouse_1" && ($result4['STONE'] + $ammount) >= 500) {
                            $stone = 500;
                        } else if ($result3[5]["BUILDING"] == "storehouse_2" && ($result4['STONE'] + $ammount) >= 1000) {
                            $stone = 1000;
                        } else if ($result3[5]["BUILDING"] == "storehouse_3" && ($result4['STONE'] + $ammount) >= 1500) {
                            $stone = 1500;
                        }
                        ...
                        if ($result3[5]["BUILDING"] == "storehouse_1" && ($result4['IRON'] + $ammount) >= 500) {
                            $iron = 500;
                        } else if ($result3[5]["BUILDING"] == "storehouse_2" && ($result4['IRON'] + $ammount) >= 1000) {
                            $iron = 1000;
                        } else if ($result3[5]["BUILDING"] == "storehouse_3" && ($result4['IRON'] + $ammount) >= 1500) {
                            $iron = 1500;
                        }
